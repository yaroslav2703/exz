...
(function() {
  ...
  ref1 = require('xmlbuilder/lib/Utility'), isObject = ref1.isObject, isFunction = ref1.isFunction, isEmpty = ref1.isEmpty, getValue = ref1.getValue;
  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent1) {
      ...
      if (!XMLElement) {
        ...
        XMLDummy = require('xmlbuilder/lib/XMLDummy');
        NodeType = require('xmlbuilder/lib/NodeType');
        XMLNodeList = require('xmlbuilder/lib/XMLNodeList');
        XMLNamedNodeMap = require('xmlbuilder/lib/XMLNamedNodeMap');
        DocumentPosition = require('xmlbuilder/lib/DocumentPosition');
      }
    }
