...
var assertType = require('assert-args/lib/assert-type.js')
var isClass = require('assert-args/lib/is-class.js')
var NoClass = function () {}
var startsWithVowel = require('assert-args/lib/starts-with-vowel.js')
var classes = {
  // primitive classes
  string: String,
  number: Number,
...
function validate (key, arg, validator, _plural) {
  ...
  if (Array.isArray(validator)) {
    // circular require
    return require('assert-args/lib/multi-validate.js')(key, arg, validator)
